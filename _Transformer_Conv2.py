...
# ----------------------------------------------------------------------------------- stc+dsa
        ...
        # self.conv1 = nn.Conv1d(dimension, dimension, kernel_size=3, groups=dimension)
        # self.conv1_o = nn.Conv1d(dimension, 32, kernel_size=1)
        # self.conv1_1 = nn.Conv1d(32, 32, kernel_size=3, groups=32)
        # self.conv1_1o = nn.Conv1d(32, 64, kernel_size=1)
        # self.conv1_2 = nn.Conv1d(64, 64, kernel_size=3, groups=64)
        # self.conv1_2o = nn.Conv1d(64, d_k * n_heads, kernel_size=1)
        #
        # self.conv2 = nn.Conv1d(dimension, dimension, kernel_size=3, groups=dimension)
        # self.conv2_o = nn.Conv1d(dimension, 32, kernel_size=1)
        # self.conv2_1 = nn.Conv1d(32, 32, kernel_size=3, groups=32)
        # self.conv2_1o = nn.Conv1d(32, 64, kernel_size=1)
        # self.conv2_2 = nn.Conv1d(64, 64, kernel_size=3, groups=64)
        # self.conv2_2o = nn.Conv1d(64, d_k * n_heads, kernel_size=1)
        # self.chomp1 = Chomp1d(2)
        # self.chomp2 = Chomp1d(4)
        #
        # self.W_Q = nn.Sequential(self.conv1, self.conv1_o,
        #                          self.conv1_1, self.conv1_1o,
        #                          self.conv1_2, self.conv1_2o)
        # self.W_K = nn.Sequential(self.conv2, self.conv2_o,
        #                          self.conv2_1, self.conv2_1o,
        #                          self.conv2_2, self.conv2_2o)
# -----------------------------------------------------------------------------------
#         self.conv1 = nn.Conv1d(dimension, 10, kernel_size=3, padding=2, groups=10)
#         self.conv1_5 = nn.Conv1d(10, d_k * n_heads, kernel_size=1)
#         # self.conv1_5 = nn.Conv1d(10, d_k * n_heads, kernel_size=3, padding=2)
#
#         self.conv2 = nn.Conv1d(dimension, 10, kernel_size=3, padding=2, groups=10)
#         self.conv2_5 = nn.Conv1d(10, d_k * n_heads, kernel_size=1)
...
# ----------------------------------------------------------------------------------- dcc+dsa
        ...
        # self.conv1 = nn.Conv1d(dimension, dimension, kernel_size=3, padding=2, dilation=1, groups=dimension)
        # self.conv1_o = nn.Conv1d(dimension, 32, kernel_size=1)
        # self.conv1_1 = nn.Conv1d(32, 32, kernel_size=3, padding=4, dilation=2, groups=32)
        # self.conv1_1o = nn.Conv1d(32, 64, kernel_size=1)
        # self.conv1_2 = nn.Conv1d(64, 64, kernel_size=3, padding=8, dilation=4, groups=64)
        # self.conv1_2o = nn.Conv1d(64, d_k * n_heads, kernel_size=1)
        #
        # self.conv2 = nn.Conv1d(dimension, dimension, kernel_size=3, padding=2, dilation=1, groups=dimension)
        # self.conv2_o = nn.Conv1d(dimension, 32, kernel_size=1)
        # self.conv2_1 = nn.Conv1d(32, 32, kernel_size=3, padding=4, dilation=2, groups=32)
        # self.conv2_1o = nn.Conv1d(32, 64, kernel_size=1)
        # self.conv2_2 = nn.Conv1d(64, 64, kernel_size=3, padding=8, dilation=4, groups=64)
        # self.conv2_2o = nn.Conv1d(64, d_k * n_heads, kernel_size=1)
        # self.chomp1 = Chomp1d(2)
        # self.chomp2 = Chomp1d(4)
        #
...
# --------------------------------------------------------------------------------------------------- dcc+dsa
        self.conv1 = weight_norm(nn.Conv1d(dimension, dimension, kernel_size=7, padding=6, dilation=1, groups=dimension))
        self.conv1_o = weight_norm(nn.Conv1d(dimension, 32, kernel_size=1))
        self.conv1_1 = weight_norm(nn.Conv1d(32, 32, kernel_size=7, padding=12, dilation=2, groups=32))
        self.conv1_1o = weight_norm(nn.Conv1d(32, 64, kernel_size=1))
        self.conv1_2 = weight_norm(nn.Conv1d(64, 64, kernel_size=7, padding=24, dilation=4, groups=64))
        self.conv1_2o = weight_norm(nn.Conv1d(64, d_k * n_heads, kernel_size=1))

        self.conv2 = weight_norm(nn.Conv1d(dimension, dimension, kernel_size=7, padding=6, dilation=1, groups=dimension))
        self.conv2_o = weight_norm(nn.Conv1d(dimension, 32, kernel_size=1))
        self.conv2_1 = weight_norm(nn.Conv1d(32, 32, kernel_size=7, padding=12, dilation=2, groups=32))
        self.conv2_1o = weight_norm(nn.Conv1d(32, 64, kernel_size=1))
        self.conv2_2 = weight_norm(nn.Conv1d(64, 64, kernel_size=7, padding=24, dilation=4, groups=64))
...
class Net(nn.Module):
    def __init__(self, c_in, c_out, d_model=256, n_layers=1, n_heads=4, d_k=None, d_v=None, d_ff=None, res_attention=True,
    ...
    def forward(self, x):
        ...
        # print('total_time:{:.4f}'.format(total_time))
